...
11. [Argumenty příkazové řádky (CLI)](./12-argumenty-prikazove-radky/) 
12. [Virtuální prostředí a správa balíčků](./13-prostredi-a-balicky/) 
13. [Generatory a Iteratory](./14-generatory-a-iteratory/)
